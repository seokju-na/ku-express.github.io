(function () {
    ...
    app.RollerCoasterGeometry = RollerCoasterGeometry;
    app.RollerCoasterLiftersGeometry = RollerCoasterLiftersGeometry;
    app.RollerCoasterShadowGeometry = RollerCoasterShadowGeometry;
    app.SkyGeometry = SkyGeometry;
    app.TreesGeometry = TreesGeometry;
